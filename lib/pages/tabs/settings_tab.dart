...
class _SettingsTabState extends ConsumerState<SettingsTab> {
  ...
  void initState() {
    ...
    _aliasController.text = jsonDecode(settings.alias)['alias'];
            ...
            Padding(
              ...
              child: _SettingsEntry(
                ...
                child: TextFieldTv(
                  ...
                  onChanged: (s) async {
                    dynamic aliasMap = jsonDecode(settings.alias);
                    aliasMap['alias'] = s;
                    await ref
                        .read(settingsProvider.notifier)
                        .setAlias(jsonEncode(aliasMap));
                  },
                ),
              ),
            ),
              ...
              children: [
                AnimatedCrossFade(
                  crossFadeState: serverState != null &&
                          (serverState.alias != settings.alias ||
                              serverState.port != settings.port ||
                              serverState.https != settings.https)
                ...
                _SettingsEntry(
                  label:
                      '${t.settingsTab.network.server}${serverState == null ? ' (${t.general.offline})' : ''}',
                  child: DecoratedBox(
                        ...
                        if (serverState == null)
                          ...
                          Tooltip(
                            ...
                            child: TextButton(
                              ...
                              onPressed: () async {
                                try {
                                  final newServerState = await ref
                                      .read(serverProvider.notifier)
                                      .restartServer(
                                  ...
                                  if (newServerState != null) {
                                    ...
                                    _aliasController.text =
                                        newServerState.alias;
                                    _portController.text =
                                        newServerState.port.toString();
                                    await ref
                                        .read(settingsProvider.notifier)
                                        .setAlias(newServerState.alias);
                                    await ref
                                        .read(settingsProvider.notifier)
                                        .setPort(newServerState.port);
                                  }
                                } catch (e) {
                                  context.showSnackBar(e.toString());
                                }
                ...
                AnimatedCrossFade(
                  crossFadeState:
                      settings.multicastGroup != defaultMulticastGroup
                          ? CrossFadeState.showSecond
                          : CrossFadeState.showFirst,
                  duration: const Duration(milliseconds: 200),
                  alignment: Alignment.topLeft,
