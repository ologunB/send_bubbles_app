...
// v2
  ...
  @override
  String toString() {
    return 'RegisterDto(alias: $alias, version: $version, deviceModel: $deviceModel, deviceType: $deviceType, fingerprint: $fingerprint, port: $port, protocol: $protocol, download: $download)';
  }
...
abstract class _RegisterDto implements RegisterDto {
  const factory _RegisterDto(
      ...
      required final bool? download}) = _$_RegisterDto;
